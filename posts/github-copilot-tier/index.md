...
### GPT-5.4
TierS++。基本これを使えば良い。ただ、デザインとかはOpus 4.6のほうが良いかもしれない。どうでもいいがこのTier表（そもそも表じゃないが）、基本的に評価がインフレし続けるということに今更気がついた。

（以下2026/04/25追記）
### GPT-5.5
Tier不明。理由はGitHub Copilot Proでは使用できないため。噂によるとプレリク消費が7.5倍になったとか。GitHub Copilotの時代は終わったのかもしれない...。
