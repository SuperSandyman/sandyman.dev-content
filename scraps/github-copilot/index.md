...
draft: false
---
最近世間ではClaude CodeやCursor、Codex CLIが流行しているそうですが、あえてGitHub Copilotはいいぞという話をします。
...
（注意：GPT-5やClaude Sonnet 4を使ったCopilot Chat、Edit, Coding Agent の利用時には、プレミアムリクエストが定められた回数分消費されます。Proプランでは月に300件が付与されます。）
...
## 微妙なところ
### プレミアムリクエストの回数
まだ限界に達したことはありませんが、IDEでのAgentとCoding Agentを本気で回したら300回は超えてしまうのではないかなと思います。プレミアムリクエストを消費しないベースモデルがGPT-5 miniと少し弱いので、回数が増えるかベースモデルが上がるかしてほしいです。物足りなくなったらCodex CLIなどに逃げるのも良さそうです。
